        ...
        <section className="intro">
          <div className="Mission" data-aos="fade-left" data-aos-duration="3000" >
            <section>
              ...
              <div>
                <p>
                  Put simply, we want to quickly and easily connect our users to
                  events located near them. Our intent is that events are free
                  and accessible to everyone to host and attend.
                </p>
              </div>
            </section>
          </div>
          ...
          <div className="map" data-aos="flip-left" data-aos-easing="ease-out-cubic" data-aos-duration="2000">
            <img src={Map} alt="Map" />
            <div>
